...
//                ex.printStackTrace();
    ...
    /**
     * Computes the estimated distance to a target using the height of the particle in the image. For more information and graphics showing the math behind this approach see the Vision Processing section of the ScreenStepsLive documentation.
     *
    ...
    /**
     * Computes a score (0-100) estimating how rectangular the particle is by comparing the area of the particle to the area of the bounding box surrounding it. A perfect rectangle would cover the entire bounding box.
     *
    ...
    /**
     * Takes in a report on a target and compares the scores to the defined score limits to evaluate if the target is a hot target or not.
     *
